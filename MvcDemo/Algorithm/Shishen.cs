...
public class ShiShen
{
    ...
    {
        //获取天干和臧干的五行
        rywx = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(BaZi.yTianGan);
        rnwx = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(BaZi.nTianGan);
        rswx = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(BaZi.sTianGan);
        dnwx1 = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(ZangGan.nzhanggan[0]);
        dnwx2 = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(ZangGan.nzhanggan[1]);
        dnwx3 = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(ZangGan.nzhanggan[2]);
        dywx1 = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(ZangGan.yzhanggan[0]);
        dywx2 = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(ZangGan.yzhanggan[1]);
        dywx3 = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(ZangGan.yzhanggan[2]);
        dswx1 = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(ZangGan.szhanggan[0]);
        dswx2 = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(ZangGan.szhanggan[1]);
        dswx3 = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(ZangGan.szhanggan[2]);
        drwx1 = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(ZangGan.rzhanggan[0]);
        drwx2 = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(ZangGan.rzhanggan[1]);
        drwx3 = CommonClass.Get_wx(BaZi.rTianGan) + CommonClass.Get_wx(ZangGan.rzhanggan[2]);

        //获取天干和臧干的阴阳
        ryyy = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(BaZi.yTianGan);
        rnyy = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(BaZi.nTianGan);
        rsyy = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(BaZi.sTianGan);
        drnyy1 = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(ZangGan.nzhanggan[0]);
        drnyy2 = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(ZangGan.nzhanggan[1]);
        drnyy3 = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(ZangGan.nzhanggan[2]);
        dryyy1 = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(ZangGan.yzhanggan[0]);
        dryyy2 = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(ZangGan.yzhanggan[1]);
        dryyy3 = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(ZangGan.yzhanggan[2]);
        drsyy1 = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(ZangGan.szhanggan[0]);
        drsyy2 = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(ZangGan.szhanggan[1]);
        drsyy3 = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(ZangGan.szhanggan[2]);
        drryy1 = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(ZangGan.rzhanggan[0]);
        drryy2 = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(ZangGan.rzhanggan[1]);
        drryy3 = CommonClass.yinyang(BaZi.rTianGan) + CommonClass.yinyang(ZangGan.rzhanggan[2]);
