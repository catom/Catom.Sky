...
(function (ba) {
    ...
    function U(b, c, d, e) {
        c && A(c, function (c, i) {
            if (d || !t(b, i)) e && 'object' === typeof c && c && !H(c) && !G(c) && !(c instanceof RegExp) ? (b[i] || (b[i] = {
            }), U(b[i], c, d, e)) : b[i] = c
        });
        return b
    }
    ...
    function ga(b) {
        ...
        function D() {
            var a,
            b,
            c = (a = 1000 * k.waitSeconds) && h.startTime + a < (new Date).getTime(),
            f = [
            ],
            l = [
            ],
            ...
            if (!W) {
                ...
                if (c && f.length) return a = B('timeout', 'Load timeout for modules: ' + f, null, f),
                ...
                s(d, 'defined', u(this, function (f) {
                    ...
                    if (this.map.unnormalized) {
                        ...
                        try {
                            ...
                            return w(B('fromtexteval', 'fromText eval for ' + b + ' failed: ' + m, m, [
                                b
                            ]))
                        }
                        P && (M = !0);
        ...
        h = {
            ...
            completeLoad: function (a) {
                ...
                if (!b && !t(q, a) && c && !c.inited) {
                    if (k.enforceDefine && (!e || !da(e))) return p(a) ? void 0 : w(B('nodefine', 'No define call for ' + a, null, [
                        a
                    ]));
                    E([a,
                    d.deps || [],
            ...
            onScriptLoad: function (a) {
                if ('load' === a.type || ia.test((a.currentTarget || a.srcElement).readyState)) N = null,
                a = I(a),
                h.completeLoad(a.id)
            },
            onScriptError: function (a) {
                var b = I(a);
                if (!p(b.id)) return w(B('scripterror', 'Script error for: ' + b.id, a, [
                    b.id
                ]))
            }
        };
    ...
    if ('undefined' === typeof define) {
        ...
        e.load = function (b, c, d) {
            ...
            if (ea) try {
                ...
                b.onError(B('importscripts', 'importScripts failed for ' + c + ' at ' + d, i, [
                    c
                ]))
            }
        };
